...
Automatically generate diagrams for all component architecture files in an organized architecture directory (e.g., `architecture/platform-3.3.0/`).

## Arguments

Required:
- `--architecture-dir=<path>` - Path to architecture directory (e.g., `architecture/platform-3.3.0/`)
...
/generate-component-diagrams --architecture-dir=architecture/platform-3.3.0/

# Force regenerate all diagrams (even if they exist)
/generate-component-diagrams --architecture-dir=architecture/platform-3.3.0/ --force-regenerate

# Generate only specific formats
/generate-component-diagrams --architecture-dir=architecture/platform-3.3.0/ --formats=mermaid,security
```
...
```
architecture/platform-3.3.0/component-a.md
architecture/platform-3.3.0/component-b.md
architecture/platform-3.3.0/component-c.md
...
```
...
- [component-a](./component-a-component.png) - Feast feature store
- [component-b](./component-b-component.png) - KServe model serving
- [component-c](./component-c-component.png) - Model Registry
...
...
```
architecture/platform-3.3.0/
├── component-a.md
├── component-b.md
├── diagrams/                    # Shared by all components
│   ├── component-a-component.mmd
│   ├── component-a-component.png
│   ├── component-b-component.mmd
│   ├── component-b-component.png
│   └── README.md
└── PLATFORM.md
```
...
# Wait for completion...
/generate-architecture-diagrams --architecture=architecture/platform-3.3.0/component-b.md
# Wait for completion...
